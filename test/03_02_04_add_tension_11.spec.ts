...
test("chord five CM7(11)", function () {
  const analysisChord = new ChordInfoDto("CM7(11)");
...
test("chord five C#M7(11)", function () {
  const analysisChord = new ChordInfoDto("C#M7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five DbM7(11)", function () {
  const analysisChord = new ChordInfoDto("DbM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five DM7(11)", function () {
  const analysisChord = new ChordInfoDto("DM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five D#M7(11)", function () {
  const analysisChord = new ChordInfoDto("D#M7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five EbM7(11)", function () {
  const analysisChord = new ChordInfoDto("EbM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five EM7(11)", function () {
  const analysisChord = new ChordInfoDto("EM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five FM7(11)", function () {
  const analysisChord = new ChordInfoDto("FM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five F#M7(11)", function () {
  const analysisChord = new ChordInfoDto("F#M7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five GbM7(11)", function () {
  const analysisChord = new ChordInfoDto("GbM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five GM7(11)", function () {
  const analysisChord = new ChordInfoDto("GM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five G#M7(11)", function () {
  const analysisChord = new ChordInfoDto("G#M7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five AbM7(11)", function () {
  const analysisChord = new ChordInfoDto("AbM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five AM7(11)", function () {
  const analysisChord = new ChordInfoDto("AM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five A#M7(11)", function () {
  const analysisChord = new ChordInfoDto("A#M7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five BbM7(11)", function () {
  const analysisChord = new ChordInfoDto("BbM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
...
test("chord five BM7(11)", function () {
  const analysisChord = new ChordInfoDto("BM7(11)");
  analysisChord.splitChord();
  analysisChord.createBaseInfo();
  let resultArray: number[] = [];
  resultArray = createBaseChord(resultArray, analysisChord);
